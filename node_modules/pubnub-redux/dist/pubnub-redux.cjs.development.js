...
})(exports.MembershipActionType || (exports.MembershipActionType = {}));

var removingMemberships = function removingMemberships(payload, meta) {
  return {
    type: exports.MembershipActionType.REMOVING_MEMBERSHIPS,
    payload: payload,
    meta: meta
  };
};
var membershipsRemoved = function membershipsRemoved(payload, meta) {
  return {
    type: exports.MembershipActionType.MEMBERSHIPS_REMOVED,
    payload: payload,
    meta: meta
  };
};
var errorRemovingMemberships = function errorRemovingMemberships(payload, meta) {
  return {
    type: exports.MembershipActionType.ERROR_REMOVING_MEMBERSHIPS,
    payload: payload,
    meta: meta,
    error: true
  };
...
var removeMemberships = function removeMemberships(request, meta) {
  ...
  thunkFunction.type = exports.MembershipActionType.REMOVE_MEMBERSHIPS_COMMAND;
  return thunkFunction;
};

var fetchingMemberships = function fetchingMemberships(payload, meta) {
  return {
    type: exports.MembershipActionType.FETCHING_MEMBERSHIPS,
    payload: payload,
    meta: meta
  };
};
var membershipsRetrieved = function membershipsRetrieved(payload, meta) {
  return {
    type: exports.MembershipActionType.MEMBERSHIPS_RETRIEVED,
    payload: payload,
    meta: meta
  };
};
var errorFetchingMemberships = function errorFetchingMemberships(payload, meta) {
  return {
    type: exports.MembershipActionType.ERROR_FETCHING_MEMBERSHIPS,
    payload: payload,
    meta: meta,
    error: true
  };
...
var fetchMemberships = function fetchMemberships(request, meta) {
  ...
  thunkFunction.type = exports.MembershipActionType.FETCH_MEMBERSHIPS_COMMAND;
  return thunkFunction;
};

var settingMemberships = function settingMemberships(payload, meta) {
  return {
    type: exports.MembershipActionType.SETTING_MEMBERSHIPS,
    payload: payload,
    meta: meta
  };
};
var membershipsSet = function membershipsSet(payload, meta) {
  return {
    type: exports.MembershipActionType.MEMBERSHIPS_SET,
    payload: payload,
    meta: meta
  };
};
var errorSettingMemberships = function errorSettingMemberships(payload, meta) {
  return {
    type: exports.MembershipActionType.ERROR_SETTING_MEMBERSHIPS,
    payload: payload,
    meta: meta,
    error: true
  };
...
var setMemberships = function setMemberships(request, meta) {
  ...
  thunkFunction.type = exports.MembershipActionType.SET_MEMBERSHIPS_COMMAND;
  return thunkFunction;
};
...
})(exports.ChannelMembersActionType || (exports.ChannelMembersActionType = {}));

var fetchingChannelMembers = function fetchingChannelMembers(payload, meta) {
  return {
    type: exports.ChannelMembersActionType.FETCHING_CHANNEL_MEMBERS,
    payload: payload,
    meta: meta
  };
};
var channelMembersRetrieved = function channelMembersRetrieved(payload, meta) {
  return {
    type: exports.ChannelMembersActionType.CHANNEL_MEMBERS_RETRIEVED,
    payload: payload,
    meta: meta
  };
};
var errorFetchingChannelMembers = function errorFetchingChannelMembers(payload, meta) {
  return {
    type: exports.ChannelMembersActionType.ERROR_FETCHING_CHANNEL_MEMBERS,
    payload: payload,
    meta: meta,
    error: true
  };
...
var fetchChannelMembers = function fetchChannelMembers(request, meta) {
  ...
  thunkFunction.type = exports.ChannelMembersActionType.FETCH_CHANNEL_MEMBERS_COMMAND;
  return thunkFunction;
};

var settingChannelMembers = function settingChannelMembers(payload, meta) {
  return {
    type: exports.ChannelMembersActionType.SETTING_CHANNEL_MEMBERS,
    payload: payload,
    meta: meta
  };
};
var channelMembersSet = function channelMembersSet(payload, meta) {
  return {
    type: exports.ChannelMembersActionType.CHANNEL_MEMBERS_SET,
    payload: payload,
    meta: meta
  };
};
var errorSettingChannelMembers = function errorSettingChannelMembers(payload, meta) {
  return {
    type: exports.ChannelMembersActionType.ERROR_SETTING_CHANNEL_MEMBERS,
    payload: payload,
    meta: meta,
    error: true
  };
...
var setChannelMembers = function setChannelMembers(request, meta) {
  ...
  thunkFunction.type = exports.ChannelMembersActionType.SET_CHANNEL_MEMBERS_COMMAND;
  return thunkFunction;
};

var removingChannelMembers = function removingChannelMembers(payload, meta) {
  return {
    type: exports.ChannelMembersActionType.REMOVING_CHANNEL_MEMBERS,
    payload: payload,
    meta: meta
  };
};
var channelMembersRemoved = function channelMembersRemoved(payload, meta) {
  return {
    type: exports.ChannelMembersActionType.CHANNEL_MEMBERS_REMOVED,
    payload: payload,
    meta: meta
  };
};
var errorRemovingChannelMembers = function errorRemovingChannelMembers(payload, meta) {
  return {
    type: exports.ChannelMembersActionType.ERROR_REMOVING_CHANNEL_MEMBERS,
    payload: payload,
    meta: meta,
    error: true
  };
...
var removeChannelMembers = function removeChannelMembers(request, meta) {
  ...
  thunkFunction.type = exports.ChannelMembersActionType.REMOVE_CHANNEL_MEMBERS_COMMAND;
  return thunkFunction;
};
...
})(exports.MessageActionType || (exports.MessageActionType = {}));

var sendingMessage = function sendingMessage(payload, meta) {
  return {
    type: exports.MessageActionType.SENDING_MESSAGE,
    payload: payload,
    meta: meta
  };
};
var messageSent = function messageSent(payload, meta) {
  return {
    type: exports.MessageActionType.MESSAGE_SENT,
    payload: payload,
    meta: meta
  };
};
var errorSendingMessage = function errorSendingMessage(payload, meta) {
  return {
    type: exports.MessageActionType.ERROR_SENDING_MESSAGE,
    payload: payload,
    meta: meta
  };
};
var sendMessage = function sendMessage(request, meta) {
  ...
  thunkFunction.type = exports.MessageActionType.SEND_MESSAGE_COMMAND;
  return thunkFunction;
};
...
})(exports.SignalActionType || (exports.SignalActionType = {}));

var sendingSignal = function sendingSignal(payload, meta) {
  return {
    type: exports.SignalActionType.SENDING_SIGNAL,
    payload: payload,
    meta: meta
  };
};
var signalSent = function signalSent(payload, meta) {
  return {
    type: exports.SignalActionType.SIGNAL_SENT,
    payload: payload,
    meta: meta
  };
};
var errorSendingSignal = function errorSendingSignal(payload, meta) {
  return {
    type: exports.SignalActionType.ERROR_SENDING_SIGNAL,
    payload: payload,
    meta: meta
  };
};
var sendSignal = function sendSignal(request, meta) {
  ...
  thunkFunction.type = exports.SignalActionType.SEND_SIGNAL_COMMAND;
  return thunkFunction;
};

var fetchingMessageHistory = function fetchingMessageHistory(payload, meta) {
  return {
    type: exports.MessageActionType.FETCHING_MESSAGE_HISTORY,
    payload: payload,
    meta: meta
  };
};
var messageHistoryRetrieved = function messageHistoryRetrieved(payload, meta) {
  return {
    type: exports.MessageActionType.MESSAGE_HISTORY_RETRIEVED,
    payload: payload,
    meta: meta
  };
};
var errorFetchingMessageHistory = function errorFetchingMessageHistory(payload, meta) {
  return {
    type: exports.MessageActionType.ERROR_FETCHING_MESSAGE_HISTORY,
    payload: payload,
    meta: meta
  };
};
var fetchMessageHistory = function fetchMessageHistory(request, meta) {
  ...
  thunkFunction.type = exports.MessageActionType.FETCH_MESSAGE_HISTORY_COMMAND;
  return thunkFunction;
};
...
})(exports.ChannelDataActionType || (exports.ChannelDataActionType = {}));

var removingChannelData = function removingChannelData(payload, meta) {
  return {
    type: exports.ChannelDataActionType.REMOVING_CHANNEL_DATA,
    payload: payload,
    meta: meta
  };
};
var channelDataRemoved = function channelDataRemoved(payload, meta) {
  return {
    type: exports.ChannelDataActionType.CHANNEL_DATA_REMOVED,
    payload: payload,
    meta: meta
  };
};
var errorRemovingChannelData = function errorRemovingChannelData(payload, meta) {
  return {
    type: exports.ChannelDataActionType.ERROR_REMOVING_CHANNEL_DATA,
    payload: payload,
    meta: meta,
    error: true
  };
...
var removeChannelData = function removeChannelData(request, meta) {
  ...
  thunkFunction.type = exports.ChannelDataActionType.REMOVE_CHANNEL_DATA_COMMAND;
  return thunkFunction;
};

var fetchingChannelData = function fetchingChannelData(payload, meta) {
  return {
    type: exports.ChannelDataActionType.FETCHING_CHANNEL_DATA,
    payload: payload,
    meta: meta
  };
};
var channelDataRetrieved = function channelDataRetrieved(payload, meta) {
  return {
    type: exports.ChannelDataActionType.CHANNEL_DATA_RETRIEVED,
    payload: payload,
    meta: meta
  };
};
var errorFetchingChannelData = function errorFetchingChannelData(payload, meta) {
  return {
    type: exports.ChannelDataActionType.ERROR_FETCHING_CHANNEL_DATA,
    payload: payload,
    meta: meta,
    error: true
  };
...
var fetchChannelData = function fetchChannelData(request, meta) {
  ...
  thunkFunction.type = exports.ChannelDataActionType.FETCH_CHANNEL_DATA_COMMAND;
  return thunkFunction;
};

var fetchingAllChannelData = function fetchingAllChannelData(payload, meta) {
  return {
    type: exports.ChannelDataActionType.FETCHING_ALL_CHANNEL_DATA,
    payload: payload,
    meta: meta
  };
};
var allChannelDataRetrieved = function allChannelDataRetrieved(payload, meta) {
  return {
    type: exports.ChannelDataActionType.ALL_CHANNEL_DATA_RETRIEVED,
    payload: payload,
    meta: meta
  };
};
var errorFetchingAllChannelData = function errorFetchingAllChannelData(payload, meta) {
  return {
    type: exports.ChannelDataActionType.ERROR_FETCHING_ALL_CHANNEL_DATA,
    payload: payload,
    meta: meta,
    error: true
  };
...
var fetchAllChannelData = function fetchAllChannelData(request, meta) {
  ...
  thunkFunction.type = exports.ChannelDataActionType.FETCH_ALL_CHANNEL_DATA_COMMAND;
  return thunkFunction;
};

var settingChannelData = function settingChannelData(payload, meta) {
  return {
    type: exports.ChannelDataActionType.SETTING_CHANNEL_DATA,
    payload: payload,
    meta: meta
  };
};
var channelDataSet = function channelDataSet(payload, meta) {
  return {
    type: exports.ChannelDataActionType.CHANNEL_DATA_SET,
    payload: payload,
    meta: meta
  };
};
var errorSettingChannelData = function errorSettingChannelData(payload, meta) {
  return {
    type: exports.ChannelDataActionType.ERROR_SETTING_CHANNEL_DATA,
    payload: payload,
    meta: meta,
    error: true
  };
...
var setChannelData = function setChannelData(request, meta) {
  ...
  thunkFunction.type = exports.ChannelDataActionType.SET_CHANNEL_DATA_COMMAND;
  return thunkFunction;
};
...
})(exports.UserDataActionType || (exports.UserDataActionType = {}));

var removingUserData = function removingUserData(payload, meta) {
  return {
    type: exports.UserDataActionType.REMOVING_USER_DATA,
    payload: payload,
    meta: meta
  };
};
var UserDataRemoved = function UserDataRemoved(payload, meta) {
  return {
    type: exports.UserDataActionType.USER_DATA_REMOVED,
    payload: payload,
    meta: meta
  };
};
var errorRemovingUserData = function errorRemovingUserData(payload, meta) {
  return {
    type: exports.UserDataActionType.ERROR_REMOVING_USER_DATA,
    payload: payload,
    meta: meta,
    error: true
  };
...
var removeUserData = function removeUserData(request, meta) {
  ...
  thunkFunction.type = exports.UserDataActionType.REMOVE_USER_DATA_COMMAND;
  return thunkFunction;
};

var fetchingUserData = function fetchingUserData(payload, meta) {
  return {
    type: exports.UserDataActionType.FETCHING_USER_DATA,
    payload: payload,
    meta: meta
  };
};
var UserDataRetrieved = function UserDataRetrieved(payload, meta) {
  return {
    type: exports.UserDataActionType.USER_DATA_RETRIEVED,
    payload: payload,
    meta: meta
  };
};
var errorFetchingUserData = function errorFetchingUserData(payload, meta) {
  return {
    type: exports.UserDataActionType.ERROR_FETCHING_USER_DATA,
    payload: payload,
    meta: meta,
    error: true
  };
...
var fetchUserData = function fetchUserData(request, meta) {
  ...
  thunkFunction.type = exports.UserDataActionType.FETCH_USER_DATA_COMMAND;
  return thunkFunction;
};

var fetchingAllUserData = function fetchingAllUserData(payload, meta) {
  return {
    type: exports.UserDataActionType.FETCHING_ALL_USER_DATA,
    payload: payload,
    meta: meta
  };
};
var allUserDataRetrieved = function allUserDataRetrieved(payload, meta) {
  return {
    type: exports.UserDataActionType.ALL_USER_DATA_RETRIEVED,
    payload: payload,
    meta: meta
  };
};
var errorFetchingAllUserData = function errorFetchingAllUserData(payload, meta) {
  return {
    type: exports.UserDataActionType.ERROR_FETCHING_ALL_USER_DATA,
    payload: payload,
    meta: meta,
    error: true
  };
...
var fetchAllUserData = function fetchAllUserData(request, meta) {
  ...
  thunkFunction.type = exports.UserDataActionType.FETCH_ALL_USER_DATA_COMMAND;
  return thunkFunction;
};

var settingUserData = function settingUserData(payload, meta) {
  return {
    type: exports.UserDataActionType.SETTING_USER_DATA,
    payload: payload,
    meta: meta
  };
};
var UserDataSet = function UserDataSet(payload, meta) {
  return {
    type: exports.UserDataActionType.USER_DATA_SET,
    payload: payload,
    meta: meta
  };
};
var errorSettingUserData = function errorSettingUserData(payload, meta) {
  return {
    type: exports.UserDataActionType.ERROR_SETTING_USER_DATA,
    payload: payload,
    meta: meta,
    error: true
  };
...
var setUserData = function setUserData(request, meta) {
  ...
  thunkFunction.type = exports.UserDataActionType.SET_USER_DATA_COMMAND;
  return thunkFunction;
};
...
})(exports.PresenceActionType || (exports.PresenceActionType = {}));

var fetchingHereNow = function fetchingHereNow(payload, meta) {
  return {
    type: exports.PresenceActionType.FETCHING_HERE_NOW,
    payload: payload,
    meta: meta
  };
};
var hereNowRetrieved = function hereNowRetrieved(payload, meta) {
  return {
    type: exports.PresenceActionType.HERE_NOW_RETRIEVED,
    payload: payload,
    meta: meta
  };
};
var errorFetchingHereNow = function errorFetchingHereNow(payload, meta) {
  return {
    type: exports.PresenceActionType.ERROR_FETCHING_HERE_NOW,
    payload: payload,
    meta: meta
  };
};
var fetchHereNow = function fetchHereNow(request, meta) {
  ...
  thunkFunction.type = exports.PresenceActionType.HERE_NOW_COMMAND;
  return thunkFunction;
};

var fetchingPresenceState = function fetchingPresenceState(payload, meta) {
  return {
    type: exports.PresenceActionType.FETCHING_PRESENCE_STATE,
    payload: payload,
    meta: meta
  };
};
var presenceStateRetrieved = function presenceStateRetrieved(payload, meta) {
  return {
    type: exports.PresenceActionType.PRESENCE_STATE_RETRIEVED,
    payload: payload,
    meta: meta
  };
};
var errorFetchingPresenceState = function errorFetchingPresenceState(payload, meta) {
  return {
    type: exports.PresenceActionType.ERROR_FETCHING_PRESENCE_STATE,
    payload: payload,
    meta: meta
  };
};
var fetchPresenceState = function fetchPresenceState(request, meta) {
  ...
  thunkFunction.type = exports.PresenceActionType.PRESENCE_STATE_COMMAND;
  return thunkFunction;
};

var UserDataSet$1 = function UserDataSet(payload) {
  return {
    type: exports.UserDataActionType.USER_DATA_SET_EVENT,
    payload: payload
  };
};
var UserDataRemoved$1 = function UserDataRemoved(payload) {
  return {
    type: exports.UserDataActionType.USER_DATA_REMOVED_EVENT,
    payload: payload
  };
};
...
var channelDataSet$1 = function channelDataSet(payload) {
  return {
    type: exports.ChannelDataActionType.CHANNEL_DATA_SET_EVENT,
    payload: payload
  };
};
var channelDataRemoved$1 = function channelDataRemoved(payload) {
  return {
    type: exports.ChannelDataActionType.CHANNEL_DATA_REMOVED_EVENT,
    payload: payload
  };
};
...
var membershipSetEventRecieved = function membershipSetEventRecieved(payload) {
  return {
    type: exports.MembershipActionType.MEMBERSHIP_SET_EVENT,
    payload: payload
  };
};
...
var membershipRemovedEventRecieved = function membershipRemovedEventRecieved(payload) {
  return {
    type: exports.MembershipActionType.MEMBERSHIP_REMOVED_EVENT,
    payload: payload
  };
};
...
var messageReceived = function messageReceived(payload) {
  return {
    type: exports.MessageActionType.MESSAGE_RECEIVED,
    payload: payload
  };
};
...
})(exports.PresenceCategory || (exports.PresenceCategory = {}));

var userJoin = function userJoin(payload) {
  return {
    type: exports.PresenceActionType.JOIN_EVENT,
    payload: payload
  };
};
var userLeave = function userLeave(payload) {
  return {
    type: exports.PresenceActionType.LEAVE_EVENT,
    payload: payload
  };
};
var userTimeout = function userTimeout(payload) {
  return {
    type: exports.PresenceActionType.TIMEOUT_EVENT,
    payload: payload
  };
};
var userStateChange = function userStateChange(payload) {
  return {
    type: exports.PresenceActionType.STATE_CHANGE_EVENT,
    payload: payload
  };
};
  ...
  return {
    presence: function presence(payload) {
      switch (payload.action) {
        case exports.PresenceCategory.JOIN:
          dispatch(userJoin(payload));
          break;

        case exports.PresenceCategory.LEAVE:
          dispatch(userLeave(payload));
          break;

        case exports.PresenceCategory.TIMEOUT:
          dispatch(userTimeout(payload));
          break;

        case exports.PresenceCategory.STATE_CHANGE:
...
var signalReceived = function signalReceived(payload) {
  return {
    type: exports.SignalActionType.SIGNAL_RECEIVED,
    payload: payload
  };
};
...
})(exports.ErrorStatusActionType || (exports.ErrorStatusActionType = {}));

var networkIssues = function networkIssues(payload) {
  return {
    type: exports.ErrorStatusActionType.NETWORK_ISSUES_EVENT,
    payload: payload
  };
};
var accessDenied = function accessDenied(payload) {
  return {
    type: exports.ErrorStatusActionType.ACCESS_DENIED_EVENT,
    payload: payload
  };
};
var malformedResponse = function malformedResponse(payload) {
  return {
    type: exports.ErrorStatusActionType.MALFORMED_RESPONSE_EVENT,
    payload: payload
  };
};
var badRequest = function badRequest(payload) {
  return {
    type: exports.ErrorStatusActionType.BAD_REQUEST_EVENT,
    payload: payload
  };
};
var decryptionError = function decryptionError(payload) {
  return {
    type: exports.ErrorStatusActionType.DECRYPTION_ERROR_EVENT,
    payload: payload
  };
};
var timeoutConnection = function timeoutConnection(payload) {
  return {
    type: exports.ErrorStatusActionType.TIMEOUT_CONNECTION_EVENT,
    payload: payload
  };
};
var requestMessageCountExceeded = function requestMessageCountExceeded(payload) {
  return {
    type: exports.ErrorStatusActionType.REQUEST_MESSAGE_COUNT_EXCEED_EVENT,
    payload: payload
  };
};
var unknown = function unknown(payload) {
  return {
    type: exports.ErrorStatusActionType.UNKNOWN_EVENT,
    payload: payload
  };
};
...
})(exports.NetworkStatusActionType || (exports.NetworkStatusActionType = {}));
...
var networkUp = function networkUp() {
  return {
    type: exports.NetworkStatusActionType.NETWORK_UP_EVENT
  };
};
var networkDown = function networkDown() {
  return {
    type: exports.NetworkStatusActionType.NETWORK_DOWN_EVENT
  };
};
...
})(exports.SubscriptionStatusActionType || (exports.SubscriptionStatusActionType = {}));
...
var reconnected = function reconnected(payload) {
  return {
    type: exports.SubscriptionStatusActionType.RECONNECTED_EVENT,
    payload: payload
  };
};
var connected = function connected(payload) {
  return {
    type: exports.SubscriptionStatusActionType.CONNECTED_EVENT,
    payload: payload
  };
};
...
var createMessageReducer = function createMessageReducer() {
  return function (state, action) {
    ...
    switch (action.type) {
      case exports.MessageActionType.MESSAGE_RECEIVED:
        return messageReceived$1(state, action.payload);

      case exports.MessageActionType.MESSAGE_HISTORY_RETRIEVED:
...
var createSignalReducer = function createSignalReducer() {
  return function (state, action) {
    ...
    switch (action.type) {
      case exports.SignalActionType.SIGNAL_RECEIVED:
...
var createPresenceReducer = function createPresenceReducer() {
  return function (state, action) {
    ...
    switch (action.type) {
      case exports.PresenceActionType.HERE_NOW_RETRIEVED:
        return hereNow(state, action.payload);

      case exports.PresenceActionType.PRESENCE_STATE_RETRIEVED:
        return getState(state, action.payload);

      case exports.PresenceActionType.JOIN_EVENT:
        return userJoined(state, action.payload);

      case exports.PresenceActionType.LEAVE_EVENT:
      case exports.PresenceActionType.TIMEOUT_EVENT:
        return userLeft(state, action.payload);

      case exports.PresenceActionType.STATE_CHANGE_EVENT:
...
var createNetworkStatusReducer = function createNetworkStatusReducer(initializer) {
  ...
  return function networkStatusReducer(state, action) {
    ...
    switch (action.type) {
      case exports.NetworkStatusActionType.NETWORK_UP_EVENT:
        return {
          isConnected: true
        };

      case exports.NetworkStatusActionType.NETWORK_DOWN_EVENT:
        return {
          isConnected: false
        };
...
var createUserDataReducer = function createUserDataReducer() {
  return function (state, action) {
    ...
    switch (action.type) {
      case exports.UserDataActionType.USER_DATA_SET:
        return UserDataSet$2(state, action.payload);

      case exports.UserDataActionType.USER_DATA_REMOVED:
        return UserDataRemoved$2(state, action.payload);

      case exports.UserDataActionType.ALL_USER_DATA_RETRIEVED:
        return allUserDataRetrieved$1(state, action.payload);

      case exports.UserDataActionType.USER_DATA_RETRIEVED:
        return UserDataRetrieved$1(state, action.payload);

      case exports.UserDataActionType.USER_DATA_SET_EVENT:
        return UserDataSetEventReceived(state, action.payload);

      case exports.UserDataActionType.USER_DATA_REMOVED_EVENT:
        return UserDataRemovedEventReceived(state, action.payload);

      case exports.ChannelMembersActionType.CHANNEL_MEMBERS_RETRIEVED:
...
var createChannelDataReducer = function createChannelDataReducer() {
  return function (state, action) {
    ...
    switch (action.type) {
      case exports.ChannelDataActionType.CHANNEL_DATA_SET:
        return channelDataSet$2(state, action.payload);

      case exports.ChannelDataActionType.CHANNEL_DATA_REMOVED:
        return channelDataRemoved$2(state, action.payload);

      case exports.ChannelDataActionType.ALL_CHANNEL_DATA_RETRIEVED:
        return allChannelDataRetrieved$1(state, action.payload);

      case exports.ChannelDataActionType.CHANNEL_DATA_RETRIEVED:
        return channelDataRetrieved$1(state, action.payload);

      case exports.ChannelDataActionType.CHANNEL_DATA_SET_EVENT:
        return channelDataSetEventReceived(state, action.payload);

      case exports.ChannelDataActionType.CHANNEL_DATA_REMOVED_EVENT:
        return channelDataRemovedEventReceived(state, action.payload);

      case exports.MembershipActionType.MEMBERSHIPS_RETRIEVED:
...
var createMembershipReducer = function createMembershipReducer() {
  return function (state, action) {
    ...
    switch (action.type) {
      case exports.MembershipActionType.MEMBERSHIPS_RETRIEVED:
      case exports.MembershipActionType.MEMBERSHIPS_SET:
      case exports.MembershipActionType.MEMBERSHIPS_REMOVED:
        return membershipResult(state, action.payload);

      case exports.MembershipActionType.MEMBERSHIP_SET_EVENT:
        return uuidMembershipUpdatedOnChannel(state, action.payload);

      case exports.MembershipActionType.MEMBERSHIP_REMOVED_EVENT:
...
var createChannelMembersReducer = function createChannelMembersReducer() {
  return function (state, action) {
    ...
    switch (action.type) {
      case exports.ChannelMembersActionType.CHANNEL_MEMBERS_RETRIEVED:
      case exports.ChannelMembersActionType.CHANNEL_MEMBERS_SET:
      case exports.ChannelMembersActionType.CHANNEL_MEMBERS_REMOVED:
...
exports.UserDataRemoved = UserDataRemoved;
exports.UserDataRetrieved = UserDataRetrieved;
exports.UserDataSet = UserDataSet;
exports.accessDenied = accessDenied;
exports.allChannelDataRetrieved = allChannelDataRetrieved;
exports.allUserDataRetrieved = allUserDataRetrieved;
exports.badRequest = badRequest;
exports.channelDataRemoved = channelDataRemoved;
exports.channelDataRetrieved = channelDataRetrieved;
exports.channelDataSet = channelDataSet;
exports.channelMembersRemoved = channelMembersRemoved;
exports.channelMembersRetrieved = channelMembersRetrieved;
exports.channelMembersSet = channelMembersSet;
exports.combineListeners = combineListeners;
exports.connected = connected;
exports.createChannelDataListener = createChannelDataListener;
exports.createChannelDataReducer = createChannelDataReducer;
exports.createChannelMembersReducer = createChannelMembersReducer;
exports.createChannelsListReducer = createChannelsListReducer;
exports.createErrorStatusListener = createErrorStatusListener;
exports.createMembershipListener = createMembershipListener;
exports.createMembershipReducer = createMembershipReducer;
exports.createMessageListener = createMessageListener;
exports.createMessageReducer = createMessageReducer;
exports.createNetworkStatusListener = createNetworkStatusListener;
exports.createNetworkStatusReducer = createNetworkStatusReducer;
exports.createPresenceListener = createPresenceListener;
exports.createPresenceReducer = createPresenceReducer;
exports.createPubNubListener = createPubNubListener;
exports.createSignalListener = createSignalListener;
exports.createSignalReducer = createSignalReducer;
exports.createSubscriptionStatusListener = createSubscriptionStatusListener;
exports.createUserDataListener = createUserDataListener;
exports.createUserDataReducer = createUserDataReducer;
exports.createUsersListReducer = createUsersListReducer;
exports.decryptionError = decryptionError;
exports.errorFetchingAllChannelData = errorFetchingAllChannelData;
exports.errorFetchingAllUserData = errorFetchingAllUserData;
exports.errorFetchingChannelData = errorFetchingChannelData;
exports.errorFetchingChannelMembers = errorFetchingChannelMembers;
exports.errorFetchingHereNow = errorFetchingHereNow;
exports.errorFetchingMemberships = errorFetchingMemberships;
exports.errorFetchingMessageHistory = errorFetchingMessageHistory;
exports.errorFetchingPresenceState = errorFetchingPresenceState;
exports.errorFetchingUserData = errorFetchingUserData;
exports.errorRemovingChannelData = errorRemovingChannelData;
exports.errorRemovingChannelMembers = errorRemovingChannelMembers;
exports.errorRemovingMemberships = errorRemovingMemberships;
exports.errorRemovingUserData = errorRemovingUserData;
exports.errorSendingMessage = errorSendingMessage;
exports.errorSendingSignal = errorSendingSignal;
exports.errorSettingChannelData = errorSettingChannelData;
exports.errorSettingChannelMembers = errorSettingChannelMembers;
exports.errorSettingMemberships = errorSettingMemberships;
exports.errorSettingUserData = errorSettingUserData;
exports.fetchAllChannelData = fetchAllChannelData;
exports.fetchAllUserData = fetchAllUserData;
exports.fetchChannelData = fetchChannelData;
exports.fetchChannelMembers = fetchChannelMembers;
exports.fetchHereNow = fetchHereNow;
exports.fetchMemberships = fetchMemberships;
exports.fetchMessageHistory = fetchMessageHistory;
exports.fetchPresenceState = fetchPresenceState;
exports.fetchUserData = fetchUserData;
exports.fetchingAllChannelData = fetchingAllChannelData;
exports.fetchingAllUserData = fetchingAllUserData;
exports.fetchingChannelData = fetchingChannelData;
exports.fetchingChannelMembers = fetchingChannelMembers;
exports.fetchingHereNow = fetchingHereNow;
exports.fetchingMemberships = fetchingMemberships;
exports.fetchingMessageHistory = fetchingMessageHistory;
exports.fetchingPresenceState = fetchingPresenceState;
exports.fetchingUserData = fetchingUserData;
exports.hereNowRetrieved = hereNowRetrieved;
exports.malformedResponse = malformedResponse;
exports.membershipsRemoved = membershipsRemoved;
exports.membershipsRetrieved = membershipsRetrieved;
exports.membershipsSet = membershipsSet;
exports.messageHistoryRetrieved = messageHistoryRetrieved;
exports.messageSent = messageSent;
exports.networkDown = networkDown;
exports.networkIssues = networkIssues;
exports.networkUp = networkUp;
exports.presenceStateRetrieved = presenceStateRetrieved;
exports.reconnected = reconnected;
exports.removeChannelData = removeChannelData;
exports.removeChannelMembers = removeChannelMembers;
exports.removeMemberships = removeMemberships;
exports.removeUserData = removeUserData;
exports.removingChannelData = removingChannelData;
exports.removingChannelMembers = removingChannelMembers;
exports.removingMemberships = removingMemberships;
exports.removingUserData = removingUserData;
exports.requestMessageCountExceeded = requestMessageCountExceeded;
exports.sendMessage = sendMessage;
exports.sendSignal = sendSignal;
exports.sendingMessage = sendingMessage;
exports.sendingSignal = sendingSignal;
exports.setChannelData = setChannelData;
exports.setChannelMembers = setChannelMembers;
exports.setMemberships = setMemberships;
exports.setUserData = setUserData;
exports.settingChannelData = settingChannelData;
exports.settingChannelMembers = settingChannelMembers;
exports.settingMemberships = settingMemberships;
exports.settingUserData = settingUserData;
exports.signalSent = signalSent;
exports.timeoutConnection = timeoutConnection;
exports.unknown = unknown;
//# sourceMappingURL=pubnub-redux.cjs.development.js.map
