...
export declare type UserData<UserCustom extends ObjectsCustom = ObjectsCustom> = Pubnub.UUIDMetadataObject<UserCustom>;
export declare type UserDataRequestOptions = Pubnub.GetAllMetadataParameters;
export declare type UserDataRequest = Pubnub.GetUUIDMetadataParameters;
export declare type SetUserDataRequest<UserCustom extends ObjectsCustom> = Pubnub.SetUUIDMetadataParameters<UserCustom>;
export declare type FetchUserDataResponse<UserCustom extends ObjectsCustom> = Pubnub.GetUUIDMetadataResponse<UserCustom>;
export interface FetchUserDataRequest extends UserDataRequestOptions {
    uuid: string;
}
export declare type FetchAllUserDataRequest = UserDataRequestOptions;
export declare type FetchAllUserDataResponse<UserCustom extends ObjectsCustom> = Pubnub.GetAllUUIDMetadataResponse<UserCustom>;
export declare type SetUserDataEventMessage<UserCustom extends ObjectsCustom> = Pubnub.SetUUIDMetadataEvent<UserCustom>['message'];
export declare type RemoveUserDataEventMessage = Pubnub.RemoveUUIDMetadataEvent['message'];
export declare type UserDataEventMessage<UserCustom extends ObjectsCustom> = SetUserDataEventMessage<UserCustom> | RemoveUserDataEventMessage;
export declare type UsersListenerPayload<UserCustom extends ObjectsCustom> = {
...
export interface AllUserDataRetrievedAction<UserCustom extends ObjectsCustom, Meta extends ActionMeta> {
...
export interface UserDataRetrievedAction<UserCustom extends ObjectsCustom, Meta extends ActionMeta> {
...
export interface UserDataSetAction<UserCustom extends ObjectsCustom, Meta extends ActionMeta> {
...
export declare type UserDataActions<UserCustom extends ObjectsCustom, Meta extends ActionMeta> = FetchingAllUserDataAction<Meta> | AllUserDataRetrievedAction<UserCustom, Meta> | ErrorFetchingAllUserDataAction<Meta> | FetchingUserDataAction<Meta> | UserDataRetrievedAction<UserCustom, Meta> | ErrorFetchingUserDataAction<Meta> | SettingUserDataAction<Meta> | UserDataSetAction<UserCustom, Meta> | ErrorSettingUserDataAction<Meta> | RemovingUserDataAction<Meta> | UserDataRemovedAction<Meta> | ErrorRemovingUserDataAction<Meta>;
export declare type UserDataListenerActions<UserCustom extends ObjectsCustom> = UserDataSetEventAction<UserCustom> | UserDataRemovedEventAction<UserCustom>;
